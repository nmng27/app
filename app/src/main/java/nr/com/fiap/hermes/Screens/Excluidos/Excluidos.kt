...
@Composable
fun Excluidos(navController: NavController, usuarioiLogado: String) {
    ...
    val call = RetrofitFactory().getEmailService().listarPorCategoria("Excluídos",credenciais.id)
    call.enqueue(
