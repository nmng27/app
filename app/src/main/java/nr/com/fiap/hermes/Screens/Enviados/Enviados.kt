...
@Composable
fun Enviados(navController: NavController,usuariLogado:String,themeManager: ThemeManager) {
    ...
    val call = RetrofitFactory().getEmailService().listarPorCategoria("Enviados",usuariLogado)
    call.enqueue(
